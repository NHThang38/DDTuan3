...
//            }
        ...
        reTurn_bac(btnBac,new DoiMau("Mau: Bạc","Tiki","80.000đ",R.drawable.vs_bac));
        reTurn_red(btnDo,new DoiMau("Mau: Đỏ","Tiki","80.000đ",R.drawable.vs_red_a));
        reTurn_black(btnDen,new DoiMau("Mau: Đen","Tiki","80.000đ",R.drawable.vsmart_black_star));
        reTurn_blugray(btnXanhDam,new DoiMau("Mau: Xanh Đậm","Tiki","80.000đ",R.drawable.vsmart_live_xanh1));
    ...
    public void reTurn_bac(Button btn, DoiMau doi){
    ...
    public void reTurn_red(Button btn, DoiMau doi){
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                txt_Mau.setText(doi.getMau());
    ...
    public void reTurn_blugray(Button btn, DoiMau doi){
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                txt_Mau.setText(doi.getMau());
    ...
    public void reTurn_black(Button btn, DoiMau doi){
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                txt_Mau.setText(doi.getMau());
